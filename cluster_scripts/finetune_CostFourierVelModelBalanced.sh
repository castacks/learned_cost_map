...
echo Running shell script that fine-tunes CostFourierVelModel network with balanced data with a given split.
...
FOURIER_SCALE=10.0
RUN_NAME=finetune_${MODEL}_lr_3e-4_g_99e-1_bal_aug_l2_scale_${FOURIER_SCALE}
NUM_EPOCHS=50
BATCH_SIZE=1024
