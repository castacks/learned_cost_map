...
echo Running shell script that trains CostFourierVelModelRGB network with balanced data with a given split.
...
echo Training CostFourierVelModelRGB network shell script ends.
