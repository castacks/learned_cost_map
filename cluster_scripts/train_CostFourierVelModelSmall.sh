...
echo Running shell script that trains CostFourierVelModelSmall network with balanced data with a given split.
...
MODEL=CostFourierVelModelSmall
FOURIER_SCALE=10.0
...
echo Training CostFourierVelModelSmall network shell script ends.
