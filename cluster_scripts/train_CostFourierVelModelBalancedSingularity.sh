...
PACKAGE_DIR=/data1/datasets/mguamanc/learned_cost_map
...
MODELS_DIR=/data1/datasets/mguamanc/learned_cost_map/models
MAP_CONFIG=/data1/datasets/mguamanc/learned_cost_map/configs/map_params.yaml
