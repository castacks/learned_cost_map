...
TRAIN_LC_DIR=lowcost_3000
TRAIN_HC_DIR=highcost_8000
VAL_LC_DIR=lowcost_val_1000
VAL_HC_DIR=highcost_val_1000
...
RUN_NAME=train_warthog5_${MODEL}_MLP_${MLP_SIZE}_lr_${LEARNING_RATE}_freqs_${NUM_FREQS}_0
